    ...
    return (
        <div className="mx-5 my-10 bg-white shadow-md px-5 py-10 rounded-xl">
            ...
            <div className="flex justify-between my-5">
                <button className="py-2 px-10 bg-indigo-600 hover:bg-indigo-800 text-white uppercase font-bold rounded-lg md:px-7 lg:px-10" type="button" onClick={() => setEdicion(paciente)}>Editar</button>

                <button className="py-2 px-10 bg-red-600 hover:bg-red-800 text-white uppercase font-bold rounded-lg" type="button" onClick={() => eliminarPaciente(_id, nombre)}>Eliminar</button>
            </div>
        </div>
    )
}
