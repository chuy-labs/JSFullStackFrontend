...
const Formulario = () => {
    ...
    return (
        <>
            ...
            <form
                action=""
                className="bg-white py-10 px-5 mb-10 md:mb-5 shadow-md rounded-lg"
                ...
                <input
                    type="submit"
                    className="bg-indigo-600 w-full p-3 text-white uppercase font-bold hover:bg-indigo-800 hover:cursor-pointer transition-colors rounded-md"
